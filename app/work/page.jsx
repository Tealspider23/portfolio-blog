...
const projects = [
  ...
  },
  {
    ...
    title: "project 2",
    description:
      "Convoz. This is a video conferencing app built upon Stream services.",
    stack: [{ name: "NextJs" }, { name: "Stream" }, { name: "TailwindCSS" }],
    image: "/thumb2.png",
  ...
  },
  {
    ...
    title: "project 3",
    description:
      "InsightMaster.This is an AI leveraged Streamlit App that provides insights from Classification Datasets .",
    stack: [
      { name: "Streamlit" },
      { name: "Gemini" },
  ...
  },
  {
    ...
    title: "project 3",
    description:
      "Simulation Rail-Safe Development Web App . This is currently under development",
    stack: [{ name: "NextJs" }, { name: "Firebase" }, { name: "Maps" }],
    image: "/thumb4.png",
    live: "",
    github:
      "https://github.com/Tealspider23/Realtime-RailSafety-Simulation-Alerts-Application/tree/main",
  },
];
