      ...
      <section className="relative w-full h-screen">
        ...
        >
          ...
          <p className="text-xl mb-8">
            Hello! I am Amit, a software developer.
          </p>
          <div className="flex gap-4">
            ...
            <Button
              href="#about"
              className={
                "flex-1 px-6 py-3 text-black font-semibold hover:bg-accent-hover"
              }
              onClick={(e) => {
                e.preventDefault();
                scrollToAbout();
          ...
          <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
            ...
            <div className="text-center xl:text-left order-2 xl:order-none">
              ...
              <p className="max-w-[500px] mb-9 text-white/80 ">
                I specialize in designing intuitive user interfaces and have a
                strong command of front-end frameworks and libraries.
              </p>
              {/*Btn and socials */}
