...
const about = {
  title:"About me",
  description:"Welcome to the About me Section . You will find details of contact here . ",
  info:[
    {
      fieldName:"Name",
...
const education = {
  ...
  title:"My Education",
  description:
  "Here are my Educational Milestones`",
  items:[
    {
    ...
    ><div className="container mx-auto">
      <Tabs defaultValue="skills" className="flex flex-col xl:flex-row gap-[60px] ">
        ...
        <div className="min-h-[70vh] w-full">
                ...
                {skills.skillList.map((skill,index)=>{
                  return <li key={index}>
                    <TooltipProvider delayDuration={100}> 
                      <Tooltip>
                        <TooltipTrigger className={`w-full h-[150px] border border-[#232329] hover:border-accent rounded-xl flex justify-center items-center group ${styles.glassmorphic}`}>
          ...
          <TabsContent value="about" className={`w-full text-center xl:text-left ${styles.glassmorphic}`}>
            <div className="flex flex-col gap-[30px] ">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          <p className="text-white/60 ">
                            ...
                            {item.grade.XII ? ` XII - ${item.grade.XII}` : " "}
